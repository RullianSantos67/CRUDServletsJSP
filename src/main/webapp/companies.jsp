...
<body>
	...
	<div id="container" class="container-fluid">
		...
		<div id="top" class="row">
			...
			<div class="col-md-3">
				<a href="${pageContext.request.contextPath}/form-company.jsp" class="btn btn-danger pull-right h2">
					<span class="glyphicon glyphicon-plus"></span>&nbspAdicionar Empresa
				</a>
			</div>
		</div>
					...
					<tbody>
						<c:forEach var="comp" items="${companies}">
							<tr>
								...
								<td>${comp.start}</td>
								<td>${comp.end}</td>
								<td>${comp.user.nome}</td>

								<td class="actions">
									<a class="btn btn-info btn-xs"
									   href="${pageContext.request.contextPath}/company/update?companyId=${comp.id}">
								...
								<td class="actions">
									<a class="btn btn-danger btn-xs modal-remove"
									   company-id="${comp.id}"
									   company-name="${comp.name}" data-toggle="modal"
